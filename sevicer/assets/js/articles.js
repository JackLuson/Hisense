 ...
 * @Last Modified time: 2018-04-24 02:18:57
 */
/* eslint-disable */
...
function logined() {
    $(function () {
        ...
        $('#pagination').on('click', 'a', function () {
            // 获取当前点击页数
            currentPage = Number($(this).attr("data-id"));
            initPage();
            return false;
        });
        ...
        var flagList = [true, true, true, true, true, true, true, true, true, true];
        ...
        // 编辑功能部分
        console.log($('#dataset .btn-default'));
